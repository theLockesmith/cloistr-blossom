...
CREATE TABLE IF NOT EXISTS upload_sessions (
    ...
    total_size  INTEGER NOT NULL,           -- Expected total size in bytes
    ...
    bytes_received  INTEGER NOT NULL DEFAULT 0,  -- Total bytes received
    ...
    updated     INTEGER NOT NULL,           -- Last update timestamp
...
CREATE TABLE IF NOT EXISTS upload_chunks (
    ...
    offset_bytes INTEGER NOT NULL,          -- Byte offset in final file
