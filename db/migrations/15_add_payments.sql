...
ALTER TABLE users ADD COLUMN free_bytes_used INTEGER NOT NULL DEFAULT 0;
ALTER TABLE users ADD COLUMN free_bytes_limit INTEGER NOT NULL DEFAULT 0;
...
CREATE TABLE payment_requests (
    ...
    bytes_requested INTEGER NOT NULL,
